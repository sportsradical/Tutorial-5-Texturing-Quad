...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	// Load the vertex array with data. Firts tringle
	vertices[0].position = XMFLOAT3(-1.0f, -1.0f, 0.0f);  // Bottom left.
	vertices[1].position = XMFLOAT3(-1.0f,  1.0f, 0.0f);  // Top left.
	vertices[2].position = XMFLOAT3( 1.0f,  1.0f, 0.0f);  // top right.


	// Load the vertex array with data. Second tringle
	...
	// Texture Firts tringle
	vertices[0].texture = XMFLOAT2(0.0f, 0.0f);
	vertices[1].texture = XMFLOAT2(0.0f, 1.0f);
	vertices[2].texture = XMFLOAT2(1.0f, 1.0f);

	// Texture Second tringle
	vertices[3].texture = XMFLOAT2(1.0f, 1.0f);
	vertices[4].texture = XMFLOAT2(1.0f, 0.0f);
	vertices[5].texture = XMFLOAT2(0.0f, 0.0f);

	// Load the index array with data. Firts tringle
	indices[0] = 0;  // Bottom left.
	indices[1] = 1;  // Top left.
	indices[2] = 2;  // Top right.

	// Load the index array with data. Second tringle
